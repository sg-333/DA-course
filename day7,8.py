...
# Day 7. Prepare a simple login and register system using File and function only of usernames
...
# --------------------------------------------------------------------------------------------------
# Day 8. Prepare a simple login and register system using File and function of usernames and passwords
...
# ---------------------------------------SYSTEM WITH USER ACTIONS-----------------------------------
# --------------------------------------------------------------------------------------------------

# Day 8. Prepare a login and register system using File and function of usernames password, balance and user should
